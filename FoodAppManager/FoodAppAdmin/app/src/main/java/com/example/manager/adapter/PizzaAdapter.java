...
public class PizzaAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static final int VIEW_TYPE_LOADNG = 1;
    ...
    public int getItemViewType(int position) {
        return array.get(position) == null ? VIEW_TYPE_LOADNG:VIEW_TYPE_DATA;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            tensp = itemView.findViewById(R.id.itempizza_ten);
            giasp = itemView.findViewById(R.id.itempizza_gia);
            mota = itemView.findViewById(R.id.itempizza_mota);
            hinhanh = itemView.findViewById(R.id.itempizza_image);
